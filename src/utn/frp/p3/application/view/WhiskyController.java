...
import utn.frp.p3.MainApp;
import utn.frp.p3.ServerAccess;
import utn.frp.p3.Whisky;
...
// Listen for selection changes and show the Whisky details when changed.
	...
	public boolean showWhiskyEditDialog(Whisky whisky) {
		try {
			...
			loader.setLocation(MainApp.class.getResource("views/WhiskyEditDialog.fxml"));
